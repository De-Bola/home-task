...
public interface FuelTabRepository extends JpaRepository<FuelTab, Long> {
    ...
    @Query("select new com.fuel.consumption.dao.pojos.SumData(monthAndYear, sum(amountPaid)) from FuelTab " +
    ...
    @Query("select new com.fuel.consumption.dao.pojos.ConsumptionRecord" +
    ...
    @Query("select new com.fuel.consumption.dao.pojos.MonthlyStats" +
